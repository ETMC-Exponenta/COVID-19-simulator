classdef VirusPropagationExtender < handle
    ...
    methods
        function obj = VirusPropagationExtender(root)
            % Init
            if nargin < 1
    ...
    methods (Hidden)
        ...
        function [nname, npath] = cloneclass(obj, classname, sourcedir, prename)
            ...
            obj.txtrep(npath, "obj.ext = VirusPropagationExtender", "obj.ext = " + obj.getvalidname + "Extender");
            obj.txtrep(npath, "upd = VirusPropagationUpdater", "upd = " + obj.getvalidname + "Updater");
        end
